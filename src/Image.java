...
public class Image {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// création d'une matrice de la taille de l'image est en couleur CV_8UC3
			Mat mat = new Mat(image.getHeight(), image.getWidth(), CvType.CV_8UC3);
			// Remplissage matrice avec image
			mat.put(0, 0, data);
			// création d'une matrice de la taille de l'image est en NB CV_8UC1
			...
			// Création de la fenetre avec SWING
